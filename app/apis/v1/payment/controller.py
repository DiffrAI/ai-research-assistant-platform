...
async def get_usage_info(
    ...
    usage_info = {
        ...
        "searches_remaining": max(0, current_user.searches_limit - current_user.searches_used_this_month),
        "usage_percentage": (current_user.searches_used_this_month / current_user.searches_limit * 100) if current_user.searches_limit > 0 else 0,
