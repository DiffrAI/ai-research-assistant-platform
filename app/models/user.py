...
class UserInDB(UserBase):
    ...
    subscription_expires_at: Optional[datetime] = Field(default=None, description="Subscription expiry date")
...
class SubscriptionInfo(BaseModel):
    ...
    days_remaining: Optional[int] = Field(None, description="Days until subscription expires")
